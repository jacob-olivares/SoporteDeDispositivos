...
START TRANSACTION;
USE `servicioTecnico_db`;
INSERT INTO `servicioTecnico_db`.`Equipo` (`idEquipo`, `marca`, `modelo`, `tipoEquipo`, `fecha_ingreso`, `fecha_salida`, `descripcion`, `rut_encargado`, `estado`, `rut_cliente`, `precio`) VALUES (1, 'Samsung', 'R410', 1, '2011-11-04', '2011-11-05', 'ASDASD', 19128620, 'EN TALLER', '19128620-0', 10000);
