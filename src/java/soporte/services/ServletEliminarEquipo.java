 ...
 * @author jhaco
 */
public class ServletEliminarEquipo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(dEquipo.delete(id_equipo)){
            request.getSession().setAttribute("Eliminado", "yes");
            response.sendRedirect("/SoporteDeDispositivos/pages/equipos/lista.jsp");
        }else{
            request.getSession().setAttribute("Eliminado", null);
            response.sendRedirect("/SoporteDeDispositivos/pages/equipos/lista.jsp");
        }
    }
